"""Tests for Rho LiveKit session configuration and disclosure playback."""
...
from rho_document_collection_voice_agent.assistant import INITIAL_DISCLOSURE
...
def test_build_session_model_config_uses_livekit_inference_models() -> None:
