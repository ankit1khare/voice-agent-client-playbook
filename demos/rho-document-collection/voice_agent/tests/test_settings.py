"""Tests for Rho voice-agent settings."""

from pathlib import Path

from pytest import MonkeyPatch

from rho_document_collection_voice_agent.settings import (
    DEFAULT_AGENT_NAME,
    DEFAULT_LLM_MODEL,
    DEFAULT_STT_MODEL,
    DEFAULT_TTS_MODEL,
...
def test_load_settings_uses_rho_and_livekit_inference_defaults(
...
def test_load_settings_reads_dotenv_and_ignores_blank_values(
    ...
    tmp_path.joinpath(".env").write_text(
        "LIVEKIT_AGENT_NAME=custom-rho-demo\n"
    ...
    assert settings.agent_name == "custom-rho-demo"
