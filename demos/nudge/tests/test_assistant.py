"""Tests for Nudge's instructions and exact disclosure."""
...
def test_instructions_define_the_inbound_nudge_demo() -> None:
    instructions = assistant_instructions()

    assert instructions.startswith(
        "You are Nudge, an AI paperwork assistant in an inbound demonstration."
    )
    assert "caller contacted Nudge" in instructions
...
def test_inbound_agent_ends_completed_calls() -> None:
    ...
    assert INBOUND_FINAL_GOODBYE == "Thank you for calling Nudge. Have a great day."
