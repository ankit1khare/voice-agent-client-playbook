...
def test_outbound_request_round_trips_without_phone_identity_leak() -> None:
    ...
    assert parsed.participant_identity == "nudge-outbound-demo-1234"
...
def test_outbound_metadata_has_an_explicit_mode() -> None:
    ...
    assert payload["mode"] == "nudge_outbound_test"
...
def test_sip_request_uses_stored_trunk_and_privacy_controls() -> None:
    sip_request = build_sip_participant_request(
        _valid_request(),
        room_name="nudge-outbound-demo-1234",
        trunk_id="ST_nudge_test",
    )

    assert sip_request.sip_trunk_id == "ST_nudge_test"
    assert sip_request.sip_call_to == "+14155550123"
    assert sip_request.participant_identity == "nudge-outbound-demo-1234"
    assert sip_request.room_name == "nudge-outbound-demo-1234"
