"""Synthetic call data and approved help content for the Nudge demo."""
...
NUDGE_APPLYING_FAQ_URL = (
    "https://nudge.example/help-center/general-nudge-information/applying-to-nudge-faqs"
)
NUDGE_HELP_CENTER_URL = "https://nudge.example/help-center"
...
DEMO_CALL_RECORD = CentralizedCallRecord(
    record_id="nudge-demo-sep10-001",
...
LARGE_FILE_HELP = (
    "If a file is too large for the Nudge platform, do not invent or promise a "
    "secure link. Record a secure-upload-link request so Client Service can "
    "follow up through an approved channel."
)

NUDGE_SUPPORT_PHONE_SPOKEN = "1-202-555-0123"
NUDGE_SUPPORT_PHONE_E164 = "+12025550123"
NUDGE_SUPPORT_EMAIL = "support@nudge.example"
