"""LiveKit session construction for the Nudge document collection demo."""

from dataclasses import dataclass

from livekit.agents import AgentSession, TurnHandlingOptions, inference, room_io
from livekit.agents.voice import SpeechHandle
from livekit.plugins import ai_coustics, rime

from nudge_voice_agent.settings import CODA_WEBSOCKET_URL, Settings
...
def create_agent_session(settings: Settings) -> AgentSession:
    ...
    return AgentSession(
        ...
        tts=rime.TTS(
            ...
            speaker=model_config.tts_voice,
            lang=model_config.tts_language,
        ),
