"""Runtime settings for the Nudge document collection demo agent."""
...
class Settings:
    """Voice-agent settings loaded from environment variables."""
...
def load_settings() -> Settings:
    """Load settings from local dotenv files and environment variables."""
    ...
    return Settings(
        ...
        tts_language=_env("RIME_CODA_LANGUAGE", DEFAULT_TTS_LANGUAGE),
    )
