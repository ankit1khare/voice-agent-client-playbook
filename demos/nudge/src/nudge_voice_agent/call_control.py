"""Shared call-ending behavior for the Nudge demo agents."""
...
INBOUND_FINAL_GOODBYE = "Thank you for calling Nudge. Have a great day."
...
def build_end_call_tool(
    ...
    """Return the Nudge call-ending tool."""
